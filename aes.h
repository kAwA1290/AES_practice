...
public:
	...
	AES_TYPE type;
	state_t cipher(const state_t in, uint8_t Nr, const std::vector<uint32_t> w);
	state_t cipherWithDebug(const state_t in, uint8_t Nr, const std::vector<uint32_t> w);
...
const std::array<std::array<uint8_t, 16>, 16> SBOX = {
{
...
const std::array<uint32_t, 11> RCON = {
	0x00000000,
	0x01000000,
	0x02000000,
	0x04000000,
